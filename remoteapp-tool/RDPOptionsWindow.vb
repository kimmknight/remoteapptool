Public Class RDPOptionsWindow
    ...
    Dim optionsList As String(,) = {
        ...
        {"connect_to_console", "connect to console", "i", "0", "Connect to the console session of the remote computer.\n\n0 - Connect to a normal session.\n1 - Connect to the console screen.", "1"},
        ...
        {"dynamic_resolution", "dynamic resolution", "i", "1", "Determines whether the resolution of a remote session is automatically updated when the local window is resized.\n\n0 - Session resolution remains static during the session.\n1 - Session resolution updates as the local window resizes.", ""},
        ...
        {"enablerdsaadauth", "enablerdsaadauth", "i", "0", "Determines whether the client will use Microsoft Entra ID to authenticate to the remote PC. When used with Azure Virtual Desktop, this provides a single sign-on experience. This property replaces the property targetisaadjoined.\n\n0 - Connections won't use Microsoft Entra authentication, even if the remote PC supports it.\n1 - Connections will use Microsoft Entra authentication if the remote PC supports it.", ""},
        ...
        {"kdcproxyname", "kdcproxyname", "s", "", "Specifies the fully qualified domain name of a KDC proxy.", ""},
        ...
        {"maximizetocurrentdisplays", "maximizetocurrentdisplays", "i", "0", "Determines which display a remote session uses for full screen on when maximizing. Requires use multimon set to 1. Only available on Windows App for Windows and the Remote Desktop app for Windows.\n\n0 - Session is full screen on the displays initially selected when maximizing.\n1 - Session dynamically is full screen on the displays the session window spans when maximizing.", ""},
        ...
        {"redirectdrives", "redirectdrives", "i", "0", "Determines whether local disk drives on the client computer will be redirected and available in the remote session.\n\n0 - The drives on the local computer are not available in the remote session.\n1 - The drives on the local computer are available in the remote session.\n\nNote: This setting is replaced by drivestoredirect from RDC 6.0 onward.", "1"},
        ...
        {"remoteapplicationcmdline", "remoteapplicationcmdline", "s", "", "Optional command line parameters for the RemoteApp.", ""},
        ...
        {"singlemoninwindowedmode", "singlemoninwindowedmode", "i", "0", "Determines whether a multi display remote session automatically switches to single display when exiting full screen. Requires use multimon set to 1. Only available on Windows App for Windows and the Remote Desktop app for Windows.\n\n0 - A remote session retains all displays when exiting full screen.\n1 - A remote session switches to a single display when exiting full screen.", ""},
